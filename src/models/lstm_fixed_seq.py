...
Information:
- sequence length: 6, all images from 2016
...
train_sequence_generator = img_func.time_series_image_gen(
    path_to_data,
    dates,
    n_classes=n_classes,
    split='train',
...
validation_sequence_generator = img_func.time_series_image_gen(
    path_to_data,
    dates,
    n_classes=n_classes,
    split='valid',
